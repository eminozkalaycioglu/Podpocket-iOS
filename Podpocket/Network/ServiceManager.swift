...
public final class ServiceManager {
    ...
    func fetchEpisodeDetail(id: String, completion: @escaping (_ result: APIResult<EpisodeDetail>) -> Void) {
        fetch(target: .fetchEpisodeDetail(id: id), completion: completion)
    }
